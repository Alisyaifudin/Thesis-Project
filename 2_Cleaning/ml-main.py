...
X = vaex.open(join(data_dir, "training-features-main.hdf5")).values
y = vaex.open(join(data_dir, "training-main.hdf5")).values
...
with torch.no_grad():
    ...
    plt.savefig("roc-main.png", dpi=70)
    plt.show()

# save the model
torch.save(model.state_dict(), "model-wide-main.pth")
...
with torch.no_grad():
    ...
    plt.colorbar()
    plt.savefig("confusion_matrix_main.png", dpi=70)
    plt.show()