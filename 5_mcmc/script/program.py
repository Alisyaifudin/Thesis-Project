...
result_paths = {
    'DM': {
        'n': join(root_data_dir, 'MCMC-metal', 'dm', 'mock', 'n'),
        'z': join(root_data_dir, 'MCMC-metal', 'dm', 'mock', 'z'),
        'd': join(root_data_dir, 'MCMC-metal', 'dm'),
    },
    'DDDM': {
        'n': join(root_data_dir, 'MCMC-metal', 'dddm', 'mock', 'n'),
        'z': join(root_data_dir, 'MCMC-metal', 'dddm', 'mock', 'z'),
        'd': join(root_data_dir, 'MCMC-metal', 'dddm'),
    },
    'NO': {
        'n': join(root_data_dir, 'MCMC-metal', 'no', 'mock', 'n'),
        'z': join(root_data_dir, 'MCMC-metal', 'no', 'mock', 'z'),
        'd': join(root_data_dir, 'MCMC-metal', 'no'),
    }
}
...
z_dir_paths = {
    ...
    'd': join(root_data_dir, 'Effective-Volume-metal'),
}

w_dir_paths = {
    'n': join(root_data_dir, 'MCMC-mock', 'n'),
    'z': join(root_data_dir, 'MCMC-mock', 'z'),
    'd': join(root_data_dir, 'Velocity-Distribution-metal'),
}
...
class Program:
    ...
    def main(self):
        ...
        parser.add_argument(
            '-t', '--type', help='z, n, d', required=True)
