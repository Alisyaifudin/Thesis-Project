...
def initialize_prior_dm(dim, w0, sigma_w, a_raw, simple=True):
...
# ========================================================================
# ========================================================================
def initialize_walkers_dm(locs, scales, dim, simple=True):
...
# ========================================================================
# ========================================================================
def consume_samples_dm(samples_raw, dim, simple=True, flatten=False):
    skip = 0
    tot = 6
    labels = []
    if flatten:
...
def plot_fitting_dm(sampler, data, dim, alpha=0.01, n=200, log=False, path=None, simple=True, dpi=150):
    zdata, wdata = data
...
def get_dataframe_dm(sampler_new, dim, locs, scales, norm_list_DM, uni_list_DM, nwalkers, simple=True):
